// ==========================================
// EDITOR HANDLER - EDITOR_HANDLER.JS
// ==========================================
// Manages lot and unit editors, image uploads, and data saving
...
window.saveEditFromTooltip = async function (inscricao) {
    ...
    try {
        ...
        setTimeout(() => {
            if (window.showLotTooltip && lote) {
                window.showLotTooltip(lote);
            }
        }, 300);
    } catch (e) {
        console.error(e);
...
window.saveUnitEdit = async function (unitInscricao) {
    ...
    try {
        ...
        console.log('📤 Enviando payload:', edits);
        ...
        window.Toast.success('Unidade salva!');
        window.Loading.hide();
        window.closeLotTooltip();
    } catch (e) {
        console.error(e);
