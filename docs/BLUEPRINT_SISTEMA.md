...
*   **Enriquecimento:** DataStone API (via Edge Function) e Geoprocessamento local.
...
| `proprietarios` | Pessoas Físicas/Jurídicas | `id` | **Centralizador de dados**. Contém JSON `dados_enrichment` (Datastone). |
