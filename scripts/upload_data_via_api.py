...
def main():
    ...
    json_path = os.path.join(script_dir, "..", "mapa_interativo", "lotes_merged.json")
    if not os.path.exists(json_path):
         # Fallback to user provided file if standard one missing?
         # Or assume user replaces file.
         # Check for output_processed.json as implicit fallback
         alt_path = "output_processed.json"
