...
URLS_TO_TEST = [
    'https://api.datastone.com.br/v1/balance',
    'https://api.datastone.com.br/v1/profile/balance',
    'https://api.datastone.com.br/v1/credits',
    'https://api.datastone.com.br/balance'
]
