-- ============================================================================
-- MIGRATION 07: ENRICHMENT SCHEMA (DATASTONE INTEGRATION) - FIXED
-- ============================================================================
...
COMMENT ON COLUMN unidades.dados_enrichment IS 'Dados completos retornados pela API DataStone (emails, sócios, etc)';
