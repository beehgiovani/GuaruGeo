...
- ✅ **Enriquecimento de dados** via integração com DataStone API
...
### APIs Externas
- **DataStone** - Enriquecimento de dados cadastrais
...
│   ├── probe_datastone.py     # Testar API DataStone
...
├── supabase/
│   └── functions/
│       └── enrich-data/        # Edge Function DataStone
│
├── docs/                       # Documentação
...
### `probe_balance.py`
Verifica saldo da API DataStone
...
### `probe_datastone.py`
Testa chamadas à API DataStone
...
- **DataStone Key**: Apenas via Edge Function (nunca expor no frontend)
